...
var App={_kbFocus:null,init:function(){this.root=$("base").attr("href"),this.isLocalEnvironment="localhost"==window.location.hostname||window.location.hostname.match(/.*\.local$/i)||window.location.hostname.match(/.*\.vagrant$/i),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$('[data-toggle="tooltip"]').tooltip(),Dialogs.init(),Forms.init(),this.log("App initialized.")},setKeyboardFocus:function(o){this._kbFocus=o},keyboardInput:function(o){return this._kbFocus&&(this._kbFocus.value=this._kbFocus.value+o,this._kbFocus.focus()),!1},openDialog:function(o){return console.log("App.openDialog deprecated"),Dialogs.open(o)},closeDialogs:function(){return console.log("App.closeDialogs deprecated"),Dialogs.close()},redirect:function(o){window.location=o.length>1?this.root+o:this.root},urlencode:function(o){return encodeURIComponent((o+"").toString()).replace(/!/g,"%21").replace(/'/g,"%27").replace(/\(/g,"%28").replace(/\)/g,"%29").replace(/\*/g,"%2A").replace(/%20/g,"+")},log:function(o){console&&this.isLocalEnvironment&&console.log("App.js - "+o)}};
