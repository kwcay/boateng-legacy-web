...
var Analytics={track:function(e,n){return"undefined"==typeof keenClient?this.log("Keen client not loaded."):(n=n||{},n.referrer=document.referrer,n.keen=n.keen||{},n.keen.timestamp=(new Date).toISOString(),n.keen.ip="${keen.ip}",n.keen.ua="${keen.user_agent}",n.keen.addons=n.keen.addons||[],n.keen.addons.push({name:"keen:ip_to_geo",input:{ip:"keen.ip"},output:"geo_data"}),n.keen.addons.push({name:"keen:ua_parser",input:{ua_string:"keen.ua"},output:"ua_data"}),void keenClient.addEvent(e,n,function(e,n){e&&console.error("Keen.io error: "+e)}))},log:function(e){console&&this.isLocalEnvironment&&console.log("Analytics.js - "+e)}};
