...
var Analytics={track:function(e,n){return"undefined"==typeof Keen?this.log("Keen not loaded."):(n=n||{},n.referrer=document.referrer,n.keen={timestamp:(new Date).toISOString()},void Keen.addEvent(e,n,function(n,t){n?this.log('An error occured while trying to track the event "'+e+'".'):this.log('Tracking event "'+e+'".')}.bind(this)))},log:function(e){console&&this.isLocalEnvironment&&console.log("Analytics.js - "+e)}};
