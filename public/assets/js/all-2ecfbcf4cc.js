...
var Analytics={track:function(e,n){return"undefined"==typeof keenClient?this.log("Keen client not loaded."):(n=n||{},n.referrer=document.referrer,n.keen=n.keen||{},n.keen.timestamp=(new Date).toISOString(),n.keen.addons=n.keen.addons||[],n.meta={ip:"${keen.ip}",ua:"${keen.user_agent}"},n.keen.addons.push({name:"keen:ip_to_geo",input:{ip:"meta.ip"},output:"meta.geo_data"}),n.keen.addons.push({name:"keen:ua_parser",input:{ua_string:"meta.ua"},output:"meta.ua_data"}),void keenClient.addEvent(e,n,function(e,n){e&&console.error("Keen.io error: "+e)}))},log:function(e){console&&this.isLocalEnvironment&&console.log("Analytics.js - "+e)}};
var App={_kbFocus:null,init:function(){this.root=$("base").attr("href"),this.isLocalEnvironment=!("localhost"!=window.location.hostname&&!window.location.hostname.match(/.*\.local$/i)&&!window.location.hostname.match(/.*\.vagrant$/i)),$.ajaxSetup({headers:{"X-CSRF-TOKEN":$('meta[name="csrf-token"]').attr("content")}}),$(document).ready(function(){Dialogs.init(),Forms.init(),$('[data-toggle="tooltip"]').tooltip(),this.log("App initialized.")}.bind(this))},setKeyboardFocus:function(o){this._kbFocus=o},keyboardInput:function(o){return this._kbFocus&&(this._kbFocus.value=this._kbFocus.value+o,this._kbFocus.focus()),!1},openDialog:function(o){return console.log("App.openDialog deprecated"),Dialogs.open(o)},closeDialogs:function(){return console.log("App.closeDialogs deprecated"),Dialogs.close()},redirect:function(o){window.location=o.length>1?this.root+o:this.root},urlencode:function(o){return encodeURIComponent((o+"").toString()).replace(/!/g,"%21").replace(/'/g,"%27").replace(/\(/g,"%28").replace(/\)/g,"%29").replace(/\*/g,"%2A").replace(/%20/g,"+")},log:function(o){console&&this.isLocalEnvironment&&console.log("App.js - "+o)}};App.init();
var Dialogs={init:function(){$(".close").click(App.closeDialogs.bind(App)),$(".has-dropdown-menu").dropdown()},open:function(o){return $(".dialog").hide(),this.toggle(o)},toggle:function(o){return box=".dialog."+o,$(box).is(":hidden")?$(box).fadeIn(240):$(box).fadeOut(240),!1},close:function(){return $(".dialog").fadeOut(240),!1},setupAddResourceForm:function(o){$(o).find(".prompt").val("")},addResource:function(){var o=document.addResourceDialogForm.lang.value.trim();return!(o.length<3)&&(App.redirect(o+"/+"+$(document.addResourceDialogForm.type).val()),!1)}};
var Forms={_def:{},init:function(){$(".text-input").focus(function(){App.setKeyboardFocus(this),$("#keyboard").fadeIn(300)}),$(".en-text-input").focus(function(){App.setKeyboardFocus(null),$("#keyboard").fadeOut(300)}),$("#keyboard").draggable({drag:function(e){Utilities.log(e)},scroll:!0,scrollSensitivity:80})},getDefinitionForm:function(e){return this._def[e]},setupLangSearch:function(e,n,a,t){if($(e)){$(e).selectize({valueField:"code",labelField:"name",searchField:["code","name","altNames"],options:n,plugins:t||null,create:!1,maxItems:a||1,render:{item:function(e,n){return'<div><span class="name">'+n(e.name)+"</span></div>"},score:function(e){return this.getScoreFunction(e)},option:function(e,n){var a=e.name;e.parentName&&e.parentName.length&&(a+=" (a sub-language of "+e.parentName+")");var t="";return e.altNames&&e.altNames.length&&(t='<span class="hint"> &mdash; Also known as '+e.altNames+"</span>"),'<div><span class="label">'+n(a)+"</span>"+t+"</div>"}},load:function(e,n){return e.trim().length?void $.ajax({url:App.root+"api/0.1/language/search/"+App.urlencode(e.trim()),type:"GET",error:function(){n()},success:function(e){n(e)}}):n()}})}},setupDefinitionLookup:function(e,n){e=e||"search",n=n||{},this._def[e]={form:$(document[e]),results:n.results||$("#results"),query:n.query||$(document[e].q),clear:n.clear||$("input[name=clear]"),language:{code:n.langCode||!1,name:n.langName||"another language"}},$(document[e]).submit([this._def[e]],function(e){e.preventDefault();var a=e.data[0],t=a.query.val().trim();if(t.length<2)return a.query.focus(),!1;a.results.html('<div class="center">looking up '+t+"...</div>");var s="/api/0.1";s+=n.langCode?"/word/search/"+App.urlencode(t)+"?lang="+n.langCode:"/search/"+App.urlencode(t)+"?method=fulltext",$.ajax({url:s,type:"GET",error:function(e,n,t){App.log("XHR error on search form: "+t+" ("+e.status+")"),a.results.html('<div class="center">Seems like we ran into a snag <span class="fa fa-frown-o"></span> please try again later.</div>')},success:function(e){if(e.length>0){var n='<div class="center">we found <em>'+e.length+"</em> results for <i>"+t+"</i>.</div><ol>";$.each(e,function(e,a){switch(a.resourceType){case"language":var t=a.parentLanguage?' is a child language of <a href="'+a.parentLanguage.uri+'">'+a.parentLanguage.name+"</a>":"";n+='<li><a href="'+a.uri+'">'+a.name+"</a> <small>(language)</small>"+t+"</li>";break;default:n+='<li><a href="'+a.uri+'">'+a.title+"</a> <small>("+a.subType+")</small> is a "+a.type+" that means <i>"+a.translation.practical.eng+'</i> in  <a href="'+a.mainLanguage.uri+'">'+a.mainLanguage.name+"</a></li>"}}),a.results.html(n+"</ol>")}else a.results.html('<div class="center">we couldn\'t find anything matching that query <span class="fa fa-frown-o"></span></div>')}})}),this._def[e].clear.click(function(){this.query.val(""),this.results.html('<div class="center">Use this <em>&#10548;</em> to lookup words<br />in '+this.language.name+".</div>"),this.query.focus()}.bind(this._def[e])),this._def[e].query.val().trim().length>0&&this._def[e].form.submit()},resetDefinition:function(e){this._def[e]&&(this._def[e].query.value="",this._def[e].results.html('<div class="center">Use this <em>&#10548;</em> to lookup words<br />in '+this._def[e].langName+".</div>"),this._def[e].query.focus())},lookupDefinition:function(e){if(this._def[e]){var n=this._def[e].query.value.trim();return n.length<2?(this._def[e].query.focus(),!1):(this._def[e].results.html('<div class="center">looking up '+n+"...</div>"),$.ajax({url:App.root+"/api/definition/search/"+App.urlencode(n),type:"POST",error:function(n,a,t){Forms.log("XHR error on search form: "+n.status+" ("+t+")"),Forms.setDefinitionResult(e,'<div class="center">Seems like we ran into a snag <span class="fa fa-frown-o"></span> try again?</div>')},success:function(n){if(n.results.definitions.length>0){var a='<div class="center">we found <em>'+n.results.definitions.length+"</em> definitions for <i>"+n.results.query+"</i>.</div><ol>";$.each(n.results.definitions,function(e,n){a+='<li><a href="'+n.uri+'">'+n.data+"</a> <small>("+n.type+")</small> is a word that means <i>"+n.translation.en+'</i> in  <a href="'+n.language.uri+'">'+n.language.name+"</a></li>"}),Forms.setDefinitionResult(e,a+"</ol>")}else Forms.setDefinitionResult(e,'<div class="center">we couldn\'t find anything matching that query <span class="fa fa-frown-o"></span></div>')}}),!1)}},setDefinitionResult:function(e,n){this._def[e]&&this._def[e].results.html(n)},log:function(e){console&&this.isLocalEnvironment&&console.log("Forms.js - "+e)}};
var Resources={checkDefinitionTitle:function(n){if(n&&n.trim().length){n.addClass("loading");({langCode:!1,onError:function(n,o,i){Resources.log("XHR error: "+i)}.bind(n),onSuccess:function(n){}});this.findDefinitionByTitle(n.value,function(){})}},findDefinitionByTitle:function(n,o){if(n.trim().length){o=o||{};var i=App.root+"/definition/exists/"+App.urlencode(n)+(o.langCode?"?lang="+o.langCode:"");$.ajax({url:i,type:"POST",error:o.onError,success:o.onSuccess})}},log:function(n){console&&this.isLocalEnvironment&&console.log("Resources.js - "+n)}};
var Utilities={urlencode:function(o){return encodeURIComponent((o+"").toString()).replace(/!/g,"%21").replace(/'/g,"%27").replace(/\(/g,"%28").replace(/\)/g,"%29").replace(/\*/g,"%2A").replace(/%20/g,"+")},setData:function(o,e){window.localStorage&&"function"==typeof window.localStorage.setItem?window.localStorage.setItem(o,e):(this.localStorage||(this.localStorage={}),this.localStorage[o]=e)},setState:function(o,e){window.sessionStorage&&"function"==typeof window.sessionStorage.setItem?window.sessionStorage.setItem(o,e):(this.sessionStorage||(this.sessionStorage={}),this.sessionStorage[o]=e)},getState:function(o,e){window.sessionStorage&&"function"==typeof window.sessionStorage.getItem?window.sessionStorage.getItem(o,value):(this.sessionStorage||(this.sessionStorage={}),this.sessionStorage[o]=value)},log:function(o){App.isLocalEnvironment&&console&&console.log(o)},info:function(o){console&&"function"==typeof console.info&&console.info(o)},error:function(o){return console&&"function"==typeof console.error&&console.error(o),!1}};
!function(e){e.fn.alphabetField=function(t){if(this.addClass("remote"),"object"==typeof t.selectizeItems&&(!Array.isArray(t.selectizeItems)||void 0===typeof t.selectizeItems.length)){var n=[];for(var i in t.selectizeItems){var s={};s[i]=t.selectizeItems[i],n.push(s)}t.selectizeItems=n}this.selectize({valueField:"code",labelField:"name",searchField:["code","name","transliteration"],options:t.selectizeItems,plugins:t.selectizePlugins||null,create:!1,maxItems:t.maxItems||10,render:{item:function(e,t){return'<div><span class="name">'+t(e.name)+"</span></div>"},option:function(e,t){return'<div><span class="label">'+t(e.name)+"</span> ("+t(e.code)+")</div>"}},load:function(t,n){return t.trim().length?void e.ajax({url:"/api/0.1/alphabet/search/"+App.urlencode(t.trim()),type:"GET",error:function(){n()},success:function(e){n(e)}}):n()},onItemAdd:t.onItemAdd||null});return this}}(jQuery);
!function(n){n.fn.alphabetLookup=function(e){this.resourceLookup(n.extend(e,{valueField:"code",labelField:"name",searchField:["code","name","transliteration"],apiEndpoint:App.root+"api/0.1/alphabet/search/:query",render:{item:function(n,e){return'<div><span class="name">'+e(n.name)+"</span></div>"},option:function(n,e){var a=n.name;return n.transliteration&&n.transliteration.length&&(a+=" ("+n.transliteration+")"),'<div><span class="label">'+e(a)+"</span></div>"}}}));return this}}(jQuery);
!function(t){t.fn.copyOnClick=function(t){var o=new Clipboard(this.selector);return this.css("cursor","pointer"),o.on("success",function(t){t.clearSelection(),alert("Copied to clipboard!")}),o.on("error",function(t){var o="",r="cut"===t.action?"X":"C";o=/iPhone|iPad/i.test(navigator.userAgent)?"No support :(":/Mac/i.test(navigator.userAgent)?"Press ⌘-"+r+" to "+action:"Press Ctrl-"+r+" to "+action,alert(o)}),this}}(jQuery);
!function(n){n.fn.countryLookup=function(a){this.resourceLookup(n.extend(a,{valueField:"code",labelField:"name",searchField:["code","name","altNames"],apiEndpoint:App.root+"api/0.1/country/search/:query",render:{item:function(n,a){return'<div><span class="name">'+a(n.name)+"</span></div>"},option:function(n,a){var e=n.name,s="";return n.altNames&&n.altNames.length&&(s='<span class="hint"> &mdash; Also known as '+n.altNames+"</span>"),'<div><span class="label">'+a(e)+"</span>"+s+"</div>"}}}));return this}}(jQuery);
!function(n){n.fn.definitionLookup=function(i){this.resourceLookup(n.extend(i,{labelField:"mainTitle",apiEndpoint:App.root+"api/0.1/definition/search/:query?lang="+(i.lang||""),render:{option:function(n,i){var a=i(n.mainTitle);return n.translation&&n.translation.practical&&n.translation.practical.eng&&(a+=" ("+i(n.translation.practical.eng)+")"),'<div><span class="label">'+a+"</span></div>"}}}));return this}}(jQuery);
var DiNkomoDictionary=function(e){e=e||{};var r={};if(r.form=$(document[e.form||"dictionary"]),r.query=$(document[e.form||"dictionary"].q),r.clear=$(e.clear||"input[name=clear]"),r.container=$(e.results||"#results"),!r.form)return Utilities.error("Dictionary form not found.");if(!r.query||!r.clear)return Utilities.error("Dictionary form not valid.");if(!r.container)return Utilities.error("Dictionary results container not found.");r.clearedContainer=r.container.html(),r.endpoint="/api/0.1/search/:query";var a=function(r){r.preventDefault();var a=r.data,n=a.query.val().trim();return n.length<2?(a.query.focus(),!1):(a.container.html('<div class="text-center">looking up '+n+"...</div>"),Analytics.track("queries",{type:"general",query:n,language:e.langCode||"",locale:"en"}),void $.ajax({url:a.endpoint.replace(":query",App.urlencode(n))+"?lang="+(e.langCode||"")+"&locale=eng",type:"GET",error:a.onSubmitError,success:function(e){if(e.length>0){var r='<div class="text-center">we found <em>'+e.length+"</em> results for <i>"+n+"</i>.</div><ol>";for(var i in e)switch(e[i].resourceType){case"language":r+=a.formatLanguageResult(e[i]);break;case"definition":r+=a.formatDefinitionResult(e[i])}a.container.html(r+"</ol>")}else a.container.html('<div class="center">we couldn\'t find anything matching that query <span class="fa fa-frown-o"></span></div>')}}))};return r.onSubmitError=function(e,r,a){Utilities.error("Dictionary error: "+a+" ("+e.status+")"),this.results.html('<div class="center">Seems like we ran into a snag <span class="fa fa-frown-o"></span> please try again later.</div>')}.bind(r),r.formatLanguageResult=function(e){var r='<li><a href="'+e.uri+'">'+e.name+"</a> ";return r+=e.parentCode&&e.parentCode.length>=3?'is a child language of <a href="'+e.parentUri+'">'+e.parentName+"</a>":"is a language",r+="</li>"},r.formatDefinitionResult=function(e){var r='<li><a href="'+e.uri+'">'+e.mainTitle+"</a> <small>("+e.subType+")</small> is a "+e.type+" that means <i>"+e.translation.practical+'</i> in <a href="'+e.mainLanguage.uri+'">'+e.mainLanguage.name+"</a></li>";return r},r.form.submit(r,a),r.clear.click(function(){this.query.val(""),this.container.html(this.clearedContainer),this.query.focus()}.bind(r)),r.query.val().trim().length>0&&r.form.submit(),Utilities.info("Dictionary form initialized."),r};
!function(e){e.fn.dictionary=function(n){n=n||{};var a={};if(a.form=this,a.query=this.find("input[name=q]"),a.clear=this.find("input[name=clear]"),a.container=e(n.results||"#results"),!a.query||!a.clear)return Utilities.error("Dictionary form not valid.");if(!a.container)return Utilities.error("Dictionary results container not found.");a.clearedContainer=a.container.html(),a.endpoint=n.endpoint||"/api/0.1/search/:query";var r=function(a){a.preventDefault();var r=a.data,i=r.query.val().trim();return i.length<2?(r.query.focus(),!1):(r.container.html('<div class="text-center">looking up '+i+"...</div>"),Analytics.track("queries",{type:"general",medium:"web",query:i,language:n.langName||n.langCode||"None specified",locale:"en"}),void e.ajax({url:r.endpoint.replace(":query",App.urlencode(i))+"?lang="+(n.langCode||"")+"&locale=en",type:"GET",error:r.onSubmitError,success:function(e){if(e.length>0){var n='<div class="text-center">we found <em>'+e.length+"</em> results for <i>"+i+"</i>.</div><ol>";for(var a in e)switch(e[a].resourceType){case"language":n+=r.formatLanguageResult(e[a]);break;case"definition":n+=r.formatDefinitionResult(e[a])}r.container.html(n+"</ol>")}else r.container.html('<div class="center">we couldn\'t find anything matching that query <span class="fa fa-frown-o"></span></div>')}}))};return a.onSubmitError=function(e,n,a){Utilities.error("Dictionary error: "+a+" ("+e.status+")"),this.results.html('<div class="center">Seems like we ran into a snag <span class="fa fa-frown-o"></span> please try again later.</div>')}.bind(a),a.formatLanguageResult=function(e){var n='<li><a href="'+e.uri+'">'+e.name+"</a> ";return n+=e.parentCode&&e.parentCode.length>=3?'is a child language of <a href="'+e.parentUri+'">'+e.parentName+"</a>":"is a language",n+="</li>"},a.formatDefinitionResult=function(e){var n='<li><a href="'+e.uri+'">'+e.mainTitle+"</a> <small>("+e.subType+")</small> is a "+e.type+" that means <i>"+e.translation.practical+'</i> in <a href="'+e.mainLanguage.uri+'">'+e.mainLanguage.name+"</a></li>";return n},a.form.submit(a,r),a.clear.click(function(){this.query.val(""),this.container.html(this.clearedContainer),this.query.focus()}.bind(a)),a.query.val().trim().length>0&&a.form.submit(),Utilities.info("Dictionary form ready."),a}}(jQuery);
!function(a){a.fn.languageLookup=function(e){this.resourceLookup(a.extend(e,{valueField:"code",labelField:"name",searchField:["code","name","transliteration","altNames"],maxItems:1,apiEndpoint:App.root+"api/0.1/language/search/:query",render:{item:function(a,e){return'<div><span class="name">'+e(a.name)+"</span></div>"},option:function(a,e){var n=a.name;a.parentName&&a.parentName.length&&(n+=" (a sub-language of "+a.parentName+")");var t="";return a.altNames&&a.altNames.length&&(t='<span class="hint"> &mdash; Also known as '+a.altNames+"</span>"),'<div><span class="label">'+e(n)+"</span>"+t+"</div>"}}}));return this}}(jQuery);
!function(e){e.fn.langSearch=function(n){n=n||{},this.addClass("remote");this.selectize({valueField:"code",labelField:"name",searchField:["code","name","altNames"],options:n.selectizeItems,plugins:n.selectizePlugins||null,create:!1,maxItems:n.maxItems||1,render:{item:function(e,n){return'<div><span class="name">'+n(e.name)+"</span></div>"},score:function(e){return this.getScoreFunction(e)},option:function(e,n){var a=e.name;e.parentName&&e.parentName.length&&(a+=" (a sub-language of "+e.parentName+")");var t="";return e.altNames&&e.altNames.length&&(t='<span class="hint"> &mdash; Also known as '+e.altNames+"</span>"),'<div><span class="label">'+n(a)+"</span>"+t+"</div>"}},load:function(n,a){return n.trim().length?void e.ajax({url:App.root+"api/0.1/language/search/"+App.urlencode(n.trim()),type:"GET",error:function(){a()},success:function(e){a(e)}}):a()},onItemAdd:n.onItemAdd||null});return this}}(jQuery);
!function(e){e.fn.referenceLookup=function(n){this.resourceLookup(e.extend(n,{valueField:"id",labelField:"name",searchField:["name","fullCitation"],apiEndpoint:App.root+"api/0.1/reference/search/:query?embed=name,fullCitation",render:{item:function(e,n){return'<div><span class="name">'+n(e.name)+"</span></div>"},option:function(e,n){return'<div><span class="label">'+n(e.fullCitation)+"</span>"+hint+"</div>"}}}));return this}}(jQuery);
!function(e){e.fn.resourceLookup=function(i){i=i||{},i.valueField=i.valueField||"uniqueId",i.delimiter=i.delimiter||",",i.labelField=i.labelField||"title",i.searchField=i.searchField||[i.labelField],i.options=i.options||i.selectizeItems,i.selectizePlugins=i.selectizePlugins||null,i.create=i.create||!1,i.maxItems=i.maxItems||100,i.loadThrottle=i.loadThrottle||600,i.render=i.render||{},i.apiEndpoint=i.apiEndpoint||App.root+"api/0.1/tag/search/:query",i.load=function(i,n){return i.trim().length?void e.ajax({url:this.apiEndpoint.replace(":query",App.urlencode(i.trim())),type:"GET",error:function(){n()},success:function(e){n(e)}}):n()}.bind(i),"function"!=typeof i.render.item&&(i.render.item=function(e,i){return'<div><span class="name">'+i(e[this.labelField])+"</span></div>"}.bind(i)),"function"!=typeof i.render.score&&(i.render.score=function(e){return this.getScoreFunction(e)}),"function"!=typeof i.render.option&&(i.render.option=function(e,i){return'<div><span class="label">'+i(e[this.labelField])+"</span></div>"}.bind(i)),this.addClass("remote");this.selectize(i);return this}}(jQuery);
!function(e){e.fn.tagSearch=function(t){t=t||{},this.addClass("remote");this.selectize({valueField:"uniqueId",labelField:"title",searchField:["title"],options:t.selectizeItems,plugins:t.selectizePlugins||null,create:!0,maxItems:t.maxItems||20,render:{item:function(e,t){return'<div><span class="name">'+t(e.title)+"</span></div>"},score:function(e){return this.getScoreFunction(e)},option:function(e,t){return'<div><span class="label">'+t(e.title)+"</span></div>"}},load:function(t,n){return t.trim().length?void e.ajax({url:App.root+"api/0.1/tag/search/"+App.urlencode(t.trim()),type:"GET",error:function(){n()},success:function(e){n(e)}}):n()},onItemAdd:t.onItemAdd||null});return this}}(jQuery);
