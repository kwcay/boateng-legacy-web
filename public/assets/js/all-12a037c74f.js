...
!function(e){e.fn.alphabetField=function(t){if(this.addClass("remote"),"object"==typeof t.selectizeItems&&(!Array.isArray(t.selectizeItems)||void 0===typeof t.selectizeItems.length)){var s=[];for(var n in t.selectizeItems){var i={};i[n]=t.selectizeItems[n],s.push(i)}t.selectizeItems=s,console.log(t.selectizeItems)}this.selectize({valueField:"code",labelField:"name",searchField:["code","name","transliteration"],options:t.selectizeItems,plugins:t.selectizePlugins||null,create:!1,maxItems:t.maxItems||10,render:{item:function(e,t){return'<div><span class="name">'+t(e.name)+"</span></div>"},option:function(e,t){return'<div><span class="label">'+t(e.name)+"</span> ("+t(e.code)+")</div>"}},load:function(t,s){return t.trim().length?void e.ajax({url:"/api/0.1/alphabet/search/"+App.urlencode(t.trim()),type:"GET",error:function(){s()},success:function(e){s(e)}}):s()},onItemAdd:t.onItemAdd||null});return this}}(jQuery);
var DiNkomoDictionary=function(e){e=e||{};var r={};if(r.form=$(document[e.form||"dictionary"]),r.query=$(document[e.form||"dictionary"].q),r.clear=$(e.clear||"input[name=clear]"),r.container=$(e.results||"#results"),!r.form)return Utilities.error("Dictionary form not found.");if(!r.query||!r.clear)return Utilities.error("Dictionary form not valid.");if(!r.container)return Utilities.error("Dictionary results container not found.");r.clearedContainer=r.container.html(),r.endpoint="/api/0.1/search/:query";var a=function(r){r.preventDefault();var a=r.data,i=a.query.val().trim();return i.length<2?(a.query.focus(),!1):(a.container.html('<div class="text-center">looking up '+i+"...</div>"),void $.ajax({url:a.endpoint.replace(":query",App.urlencode(i))+"?lang="+(e.langCode||""),type:"GET",error:a.onSubmitError,success:function(e){if(e.length>0){var r='<div class="text-center">we found <em>'+e.length+"</em> results for <i>"+i+"</i>.</div><ol>";for(var n in e)switch(e[n].resourceType){case"language":r+=a.formatLanguageResult(e[n]);break;case"definition":r+=a.formatDefinitionResult(e[n])}a.container.html(r+"</ol>")}else a.container.html('<div class="center">we couldn\'t find anything matching that query <span class="fa fa-frown-o"></span></div>')}}))};return r.onSubmitError=function(e,r,a){Utilities.error("Dictionary error: "+a+" ("+e.status+")"),this.results.html('<div class="center">Seems like we ran into a snag <span class="fa fa-frown-o"></span> please try again later.</div>')}.bind(r),r.formatLanguageResult=function(e){var r='<li><a href="'+e.uri+'">'+e.name+"</a> ";return r+=e.parentLanguage?'is a child language of <a href="'+e.parentLanguage.uri+'">'+e.parentLanguage.name+"</a>":"is a language",r+="</li>"},r.formatDefinitionResult=function(e){var r='<li><a href="'+e.uri+'">'+e.titles[0].title+"</a> <small>("+e.subType+")</small> is a "+e.type+" that means <i>"+e.translation.practical.eng+'</i> in <a href="'+e.mainLanguage.uri+'">'+e.mainLanguage.name+"</a></li>";return r},r.form.submit(r,a),r.clear.click(function(){this.query.val(""),this.container.html(this.clearedContainer),this.query.focus()}.bind(r)),r.query.val().trim().length>0&&r.form.submit(),Utilities.info("Dictionary form initialized."),r};
!function(e){e.fn.langSearch=function(n){this.addClass("remote");this.selectize({valueField:"code",labelField:"name",searchField:["code","name","altNames"],options:n.selectizeItems,plugins:n.selectizePlugins||null,create:!1,maxItems:n.maxItems||1,render:{item:function(e,n){return'<div><span class="name">'+n(e.name)+"</span></div>"},score:function(e){return this.getScoreFunction(e)},option:function(e,n){var a=e.name;e.parentName&&e.parentName.length&&(a+=" (a sub-language of "+e.parentName+")");var t="";return e.altNames&&e.altNames.length&&(t='<span class="hint"> &mdash; Also known as '+e.altNames+"</span>"),'<div><span class="label">'+n(a)+"</span>"+t+"</div>"}},load:function(n,a){return n.trim().length?void e.ajax({url:App.root+"api/0.1/language/search/"+App.urlencode(n.trim()),type:"GET",error:function(){a()},success:function(e){a(e)}}):a()},onItemAdd:n.onItemAdd||null});return this}}(jQuery);
