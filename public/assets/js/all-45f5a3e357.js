...
var Analytics={track:function(e,n){return"undefined"==typeof keenClient?this.log("Keen client not loaded."):(n=n||{},n.referrer=document.referrer,n.keen={timestamp:(new Date).toISOString()},void keenClient.addEvent(e,n,function(n,o){n?console.error("Keen.io error: "+n):console.info('Tracking event "'+e+'".')}))},log:function(e){console&&this.isLocalEnvironment&&console.log("Analytics.js - "+e)}};
